<?php
// HTTP
define('HTTP_SERVER', 'http://www.kratosynthe.ml/admin/');
define('HTTP_CATALOG', 'http://www.kratosynthe.ml/');

// HTTPS
define('HTTPS_SERVER', 'https://www.kratosynthe.ml/admin/');
define('HTTPS_CATALOG', 'https://www.kratosynthe.ml/');
